...
<head>
    ...
    <script type="text/javascript" src="<%=request.getContextPath() %>/js/user-manage.js"></script>
...
<body>
				...
				<div class="col-xs-8">
					<div class="dropdown text-right">
						...
						<ul id="userResetPwd" class="dropdown-menu pull-right" role="menu"
							aria-labelledby="dropdownMenu1" style="margin-top:-20px;padding: 3px 3px 3px 3px">
							<li role="presentation">
								<a id="resetPwd" role="menuitem" tabindex="-1" href="#">
									<span class="glyphicon glyphicon-lock"></span>重置密码
								</a>
							</li>
							<li role="presentation">
								<a id="logout" role="menuitem" tabindex="-1" href="<%=request.getContextPath()%>/logout">
									<span style="margin-right:15px" class="glyphicon glyphicon-off"></span>退出登录
								</a>
							</li>
						</ul>
					</div>
	...
	<div class="container-fluid page">
		<div class="sidebar">
			<ul class="nav nav-pills nav-stacked">
				...
				<li class="active"><a href="<%=request.getContextPath()%>/user/manage">用户管理<small>User
							Management</small></a></li>
		...
		<div class="content">
			<div class="detail">
				<h4 class="title">
					<strong>用户管理</strong><small>User Management</small>
				</h4>

				<form id="searchUser" class="form-inline">
					<div class="form-group">
						<label>账号<small>Account</small></label> <input type="text"
							class="form-control" placeholder="请输入账号" name="account">
					</div>

					<div class="form-group">
						<label>姓名<small>Name</small></label> <input type="text"
							class="form-control" placeholder="请输入用户姓名" name="name">
					</div>

					<div class="form-group">
						<button id="searchUserBtn" type="submit" class="btn btn-primary">
				...
				<div class="table-responsive">
					<div class="pull-left btn-group">
						<button id="userAdd" class="btn btn-default" data-toggle="modal" title="新建">
							<!-- 新建 <small>Add</small> -->
							<span class="glyphicon glyphicon-plus"></span>
						</button>
						<button id="userEdit" class="btn btn-default" data-toggle="modal" title="编辑">
							<!-- 编辑 <small>Update</small> -->
							<span class="glyphicon glyphicon-pencil"></span>
						</button>
						<button id="userRemove" class="btn btn-default" title="删除">
	...
	<!-- 
	<script src="<%=request.getContextPath() %>/js/resource/all.vendor.js"></script>
	<script src="<%=request.getContextPath() %>/js/resouce/all.js"></script>
	 -->
